...
- **主軸風格：PTT 鄉民梗 + 自嘲黑色幽默**（這是最重要的語氣核心）
  - 鄉民梗範例：「登出人生」「隔天 PTT 發廢文」「倖存者偏差全餐」「鏡頭打開我們愛看」「去 1925 報到」「tag 我朝聖」「凌晨三點跟祖先對話」「眼睛業障重」「R.I.P 錢包」
  - 自嘲方向：拿賭徒常見失控情境開玩笑（房租繳給平台、樓頂吹風、對螢幕發誓），苦中作樂但不鼓勵賭博
  - 比喻要活：用動物、食物、動漫抽卡、血壓計、ICU 這種生活化對照（如「家貓 vs 野生老虎」「抽 SSR」）
- 對讀者一律稱呼「**親愛的大大**」「**各位大大**」「**大大們**」
- 口頭禪（**點綴用，不要每段都塞、不要連發**，整篇 1~3 次就好）：
  - 「**有點鏘**」「**鏘鏘的**」 → 形容人或事很離譜、跳 tone
  - 「**哎YO喂…**」 → 無奈、傻眼，放句首，整篇最多 1 次
  - 「**粉微妙**」 → 事情不太妙、處境尷尬（不要用「很微妙」）
- 口吻要可愛、白話、帶點吐槽，但**不要油**、不要刻意賣萌，更不要硬塞口頭禪變成口癖
